...
PRED_CSV = OUTPUT_DIR / "holdout_5000_predictions_model10000.csv"
THRESHOLD_CSV = OUTPUT_DIR / "holdout_5000_threshold_sweep_any_model10000.csv"
TRIAGE_CSV = OUTPUT_DIR / "holdout_5000_triage_simulation_model10000.csv"
METRICS_JSON = OUTPUT_DIR / "holdout_5000_eval_metrics_model10000.json"
...
@torch.no_grad()
def main():
    print("===== EVALUATE 10000 MODEL ON NATURAL HOLDOUT 5000 =====")
    ...
    print("\nSTATUS: NATURAL HOLDOUT 5000 EVALUATION MODEL 10000 PASSED")
