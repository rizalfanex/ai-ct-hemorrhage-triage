...
OUT_CI_CSV = REPORT_DIR / "bootstrap_ci_convnext_tiny_10000.csv"
OUT_CI_JSON = REPORT_DIR / "bootstrap_ci_convnext_tiny_10000.json"
OUT_THRESHOLD_CI_CSV = REPORT_DIR / "bootstrap_threshold_ci_any_convnext_tiny_10000.csv"
OUT_FIG = FIG_DIR / "bootstrap_ci_auc_ap_convnext_tiny_10000.png"
...
def main() -> None:
    print("===== BOOTSTRAP CONFIDENCE INTERVALS: CONVNEXT-TINY 10000 =====")
