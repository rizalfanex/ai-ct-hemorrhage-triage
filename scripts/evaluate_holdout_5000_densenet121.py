...
CHECKPOINT_PATH = Path("outputs/models/best_densenet121_rsna_10000.pt")

OUTPUT_DIR = Path("outputs/logs")
PRED_CSV = OUTPUT_DIR / "holdout_5000_predictions_densenet121_10000.csv"
THRESHOLD_CSV = OUTPUT_DIR / "holdout_5000_threshold_sweep_any_densenet121_10000.csv"
TRIAGE_CSV = OUTPUT_DIR / "holdout_5000_triage_simulation_densenet121_10000.csv"
METRICS_JSON = OUTPUT_DIR / "holdout_5000_eval_metrics_densenet121_10000.json"
...
@torch.no_grad()
def main():
    print("===== EVALUATE DENSENET121 10000 ON NATURAL HOLDOUT 5000 =====")
    ...
    summary = {
        ...
        "model_name": model_name,
        "experiment_name": checkpoint.get("experiment_name", "densenet121_rsna_10000"),
    ...
    print("\nSTATUS: NATURAL HOLDOUT 5000 EVALUATION DENSENET121 PASSED")
