...
EXPERIMENT_NAME = "convnext_tiny_brain_only_rsna_10000"
...
class BrainWindowOnlyDataset(Dataset):
    """
    Uses the existing multi-window dataset, then keeps only channel 0.
    Assumption: channel 0 is brain window, channel 1 subdural, channel 2 bone.
    Output remains 3-channel by repeating brain window: [brain, brain, brain].
    """
    ...
    def __getitem__(self, idx):
        ...
        brain = image[0:1, :, :]
        image_brain_only = brain.repeat(3, 1, 1)

        item["image"] = image_brain_only
        return item
...
def main() -> None:
    print("===== CONVNEXT-TINY BRAIN-WINDOW ONLY TRAINING 10000 =====")
    ...
    print("Input ablation: brain window only replicated to 3 channels")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        checkpoint = {
            ...
            "ablation": "brain_window_only_repeated_3_channels",
    ...
    print("\nSTATUS: CONVNEXT-TINY BRAIN-ONLY TRAINING PASSED")
