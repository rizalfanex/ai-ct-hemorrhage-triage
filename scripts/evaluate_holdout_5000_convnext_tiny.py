...
CHECKPOINT_PATH = Path("outputs/models/best_convnext_tiny_rsna_10000.pt")

OUTPUT_DIR = Path("outputs/logs")
PRED_CSV = OUTPUT_DIR / "holdout_5000_predictions_convnext_tiny_10000.csv"
THRESHOLD_CSV = OUTPUT_DIR / "holdout_5000_threshold_sweep_any_convnext_tiny_10000.csv"
TRIAGE_CSV = OUTPUT_DIR / "holdout_5000_triage_simulation_convnext_tiny_10000.csv"
METRICS_JSON = OUTPUT_DIR / "holdout_5000_eval_metrics_convnext_tiny_10000.json"
...
@torch.no_grad()
def main():
    print("===== EVALUATE CONVNEXT-TINY 10000 ON NATURAL HOLDOUT 5000 =====")
    ...
    summary = {
        ...
        "model_name": model_name,
        "experiment_name": checkpoint.get("experiment_name", "convnext_tiny_rsna_10000"),
    ...
    print("\nSTATUS: NATURAL HOLDOUT 5000 EVALUATION CONVNEXT-TINY PASSED")
