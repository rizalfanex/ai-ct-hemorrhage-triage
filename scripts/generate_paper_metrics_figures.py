...
OUT_DIR = Path("outputs/figures/paper_metrics")
...
THRESHOLD_ANY_TRIAGE = 0.25
THRESHOLD_ANY_BEST_F1 = 0.90
...
def plot_any_roc_pr(df: pd.DataFrame) -> dict:
    ...
    plt.tight_layout()
    roc_path = OUT_DIR / "roc_curve_any_model10000.png"
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    pr_path = OUT_DIR / "pr_curve_any_model10000.png"
...
def plot_per_label_auc_ap(df: pd.DataFrame) -> pd.DataFrame:
    ...
    metrics_path = REPORT_DIR / "paper_metrics_per_label_auc_ap.csv"
    ...
    fig_path = OUT_DIR / "per_label_auc_ap_model10000.png"
...
def plot_calibration(df: pd.DataFrame) -> dict:
    ...
    calibration_path = REPORT_DIR / "calibration_curve_any_model10000.csv"
    ...
    fig_path = OUT_DIR / "calibration_curve_any_model10000.png"
    plt.savefig(fig_path, dpi=250)
    plt.close(fig)
...
def plot_confusion_matrices(df: pd.DataFrame) -> dict:
    ...
    thresholds = {
        "triage_recall90_threshold_025": THRESHOLD_ANY_TRIAGE,
        "best_f1_threshold_090": THRESHOLD_ANY_BEST_F1,
    }
...
def main() -> None:
    ...
    summary_path = REPORT_DIR / "paper_metrics_summary_model10000.json"
