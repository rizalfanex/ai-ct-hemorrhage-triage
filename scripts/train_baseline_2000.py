...
def evaluate(model, loader, criterion, device):
    ...
    any_ap = metrics["any"]["average_precision"]
...
def main() -> None:
    print("===== RSNA BASELINE 2000 TRAINING =====")
    ...
    best_any_auc = -1.0
    best_checkpoint_path = OUTPUT_MODEL_DIR / "best_efficientnet_b0_rsna_2000.pt"
    last_checkpoint_path = OUTPUT_MODEL_DIR / "last_efficientnet_b0_rsna_2000.pt"
    ...
    history_path = OUTPUT_LOG_DIR / "baseline_2000_training_history.json"
    history_path.write_text(json.dumps(history, indent=2), encoding="utf-8")

    summary_path = OUTPUT_LOG_DIR / "baseline_2000_summary.json"
    summary = {
        "model_name": MODEL_NAME,
        "epochs": EPOCHS,
        "image_size": IMAGE_SIZE,
    ...
    print("\nSTATUS: BASELINE 2000 TRAINING PASSED")
