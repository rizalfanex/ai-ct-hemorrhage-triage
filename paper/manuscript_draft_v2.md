...
ConvNeXt-Tiny outperformed DenseNet121 in any-hemorrhage AUC by 0.009313 with 95% bootstrap CI 0.001840 to 0.016482 and bootstrap p-value 0.0090. ConvNeXt-Tiny also improved AP over DenseNet121 by 0.034482 with 95% bootstrap CI 0.017094 to 0.051272.

Compared with EfficientNet-B0, ConvNeXt-Tiny improved AUC by 0.029343 with 95% bootstrap CI 0.019851 to 0.039057. It improved AP by 0.106306 with 95% bootstrap CI 0.081276 to 0.132075.
...
To test whether multi-window CT input contributed measurable benefit, ConvNeXt-Tiny was additionally trained using only the brain window replicated into three channels. The brain-only model achieved any-hemorrhage AUC 0.947194, compared with 0.945789 for the multi-window model. The paired AUC difference for multi-window minus brain-only was -0.001405, with bootstrap p-value 0.6460.

Average precision was 0.816036 for the multi-window model and 0.815377 for the brain-only model. The paired AP difference was 0.000659, with bootstrap p-value 0.9290.
